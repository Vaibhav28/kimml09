...
\item
  Tijn Schouten is University of Groningen, E-mail: .
\item
...
%% random notes
% - Discuss optimal time vs response: http://nih.academia.edu/PeterBandettini/Papers/232419/Detection_Versus_Estimation_In_Event-Related_FMRI_Choosing_the_Optimal_Stimulus_Timing
% - Discuss preprocessing data (by using the matlab functions) to avg ROI and compare results
