...
Wang et al. \cite{wa:2003betw} used GNB and Support Vector Machine (SVM) as cross-subject classifiers in a sentence versus picture study, in a similar context as our conducted study. When using the averaging technique (averaging all voxels in an ROI into a supervoxel) and normalization, GNB yielded a predictive performance of 74.3\%, while SVM 75.3\%.
