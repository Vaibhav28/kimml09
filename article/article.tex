...
\end{tabular}}
\caption{Performance results (in \%) of the three classifiers for different methods for feature selection and structure.}
\label{tab:results}
\end{table*}
